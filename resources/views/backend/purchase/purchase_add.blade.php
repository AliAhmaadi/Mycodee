                            ...
                            <table class="table-sm table-bordered" width="100%" style="border-color: #ddd;">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5"></td>
                                        <td>
                                            <input type="text" name="estimated-amount" value="0" id="estimated-amount" class="form-control estimated-amount" readonly style="background-color: #darkgoldenrod;">
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
...
<script>
    $(document).ready(function() {
        $(document).on("click", ".addeventmore", function() {
            ...
            if (date == '') {
                $.notify("Date is Required", { position: 'top right', className: 'error' });
                return false;
            }
            if (purchase_no == '') {
            ...
            if (category_id == '') {
                $.notify("Category is Required", { position: 'top right', className: 'error' });
                return false;
            }
            if (supplier_id == '') {
                $.notify("Supplier is Required", { position: 'top right', className: 'error' });
                return false;
            }
            if (product_id == '') {
                $.notify("Product is Required", { position: 'top right', className: 'error' });
                return false;
            }
        ...
        $(document).on('keyup click', '.unit_price,.buying_qty', function () {
            ...
            var qty = parseFloat($(this).closest("tr").find("input.buying_qty").val());
